...
> [!TLDR]
> Bilingual Movie Learn là nền tảng học tiếng Anh tương tác qua phim ảnh, giúp người học tra cứu từ vựng theo ngữ cảnh và giải thích ngữ pháp tức thì từ câu thoại video thông qua Google Gemini API.
>
> **Vai trò:** Toàn bộ quá trình từ thiết kế kiến trúc, xây dựng frontend Next.js/TypeScript, backend FastAPI và đóng gói Docker.

## Bối cảnh và bài toán thực tế

Xem phim là phương pháp học tiếng Anh tự nhiên và hấp dẫn, nhưng người học thường gặp ba rào cản:
...
### Giải pháp cốt lõi
Xây dựng trình phát video chuyên dụng kết hợp phụ đề song ngữ đồng bộ chính xác theo từng khung hình:
...
## Kiến trúc hệ thống và dòng chảy dữ liệu
...
- **Backend:** Xây dựng bằng FastAPI và Python. Cung cấp API tra cứu từ vựng, xử lý rate limiting và giao tiếp bất đồng bộ với Google Gemini API.
...
### Đồng bộ phụ đề phía trình duyệt thay vì xử lý qua máy chủ
...
- **Đánh đổi:** Tăng nhẹ thời gian khởi tạo ban đầu khoảng 100ms khi mở phim, nhưng đổi lại trải nghiệm tua video và khớp phụ đề diễn ra mượt mà không có độ trễ mạng.

### Sử dụng Google Gemini Flash API cho tác vụ phân tích tức thì
- **Bối cảnh:** Cần một mô hình AI có tốc độ phản hồi nhanh dưới 1 giây để người xem không phải chờ đợi lâu khi tạm dừng phim.
- **Quyết định:** Chọn mô hình Gemini Flash nhờ ưu thế về chi phí và thời gian sinh token đầu tiên ngắn, kết hợp prompt yêu cầu trả lời theo cấu trúc JSON ngắn gọn.
