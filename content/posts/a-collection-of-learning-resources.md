...
This curated collection gathers top-tier courses, documentation, books, and technical tools across Artificial Intelligence, Computer Science, and Software Development. Resources are updated and organized periodically by category.
{{< /admonition >}}
...
## 1. Fundamentals and Meta-Learning
...
- **[Learning How to Learn Coursera](https://www.coursera.org/learn/learning-how-to-learn)** <i class="fas fa-graduation-cap"></i> <i class="fas fa-check-circle"></i> — Popular MOOC on mental tools and memory techniques
...
- **[Pragmatic Thinking and Learning](https://pragprog.com/titles/ahprag/)** <i class="fas fa-book"></i> — Refactor your wetware and cognitive habits by Andy Hunt
...
- <i class="fas fa-star"></i> **[CS50x 2025 - Harvard](https://cs50.harvard.edu/x/)** <i class="fab fa-youtube"></i> <i class="fas fa-check-circle"></i> — Introduction to Computer Science by David J. Malan
...
- **[OpenStax](https://openstax.org/)** <i class="fas fa-book"></i> — Free, peer-reviewed open textbooks for Math, Physics, and CS

---

## 2. Software Engineering and Data Structures
...
- **[Algorithms Part I](https://www.coursera.org/learn/algorithms-part1)** <i class="fas fa-graduation-cap"></i> — Princeton course by Sedgewick and Wayne
...
- <i class="fas fa-star"></i> **[LeetCode](https://leetcode.com/)** <i class="fas fa-globe"></i> <i class="fas fa-check-circle"></i> — Standard platform for Data Structures and Algorithms practice
...
- <i class="fas fa-star"></i> **[Hands-On Machine Learning (3rd Ed)](https://www.oreilly.com/library/view/hands-on-machine-learning/9781098125967/)** <i class="fas fa-book"></i> <i class="fas fa-check-circle"></i> — Practical guide using Scikit-Learn, Keras, and TensorFlow
...
- <i class="fas fa-star"></i> **[Seeing Theory](https://seeing-theory.brown.edu/)** <i class="fas fa-globe"></i> — Visual interactive introduction to probability and statistics
...
- **[Deep Learning Book](https://www.deeplearningbook.org/)** <i class="fas fa-book"></i> — Definitive textbook by Goodfellow, Bengio, and Courville
...
- <i class="fas fa-star"></i> **[Anthropic Claude Documentation and Guides](https://docs.anthropic.com/)** <i class="fas fa-graduation-cap"></i> — Official Anthropic architecture and LLM documentation
...
- **[all-agentic-architectures](https://github.com/awslabs/multi-agent-orchestrator)** <i class="fab fa-github"></i> — Flexible multi-agent orchestrator and architectural patterns
...
- **[Stanford CS229: LLMs Lecture](https://www.youtube.com/watch?v=9vM4p9NN0Ts)** <i class="fab fa-youtube"></i> — Building Large Language Models lecture series
...
- **[AWS Machine Learning Blog](https://aws.amazon.com/blogs/machine-learning/)** <i class="fas fa-globe"></i> — Official AWS blog for ML architecture and tutorials
...
- **[Introduction to ML Systems - Stanford CS329S](https://stanford-cs329s.github.io/)** <i class="fas fa-book"></i> — Course on building production machine learning systems
- **[Triton GPU Programming Tutorial](https://triton-lang.org/)** <i class="fab fa-github"></i> — Learn GPU kernel programming and architecture interactively

---

## 5. Blogs, Personal Websites, and Community
...
- <i class="fas fa-star"></i> **[Corey Schafer YouTube](https://www.youtube.com/@coreyms)** <i class="fab fa-youtube"></i> — High quality Python, Django, and Git video tutorials
...
## 6. Developer Tools and AI Workflows
