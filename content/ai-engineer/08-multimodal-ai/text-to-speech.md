...
description: "In the context of multimodal AI, text-to-speech (TTS) technology converts written text into natural-sounding spoken language, allowing AI systems to communicate verbally."
...
- [What is Text-to-Speech?](https://aws.amazon.com/polly/what-is-text-to-speech/) (article)
- [From Text to Speech: The Evolution of Synthetic Voices](https://ignitetech.ai/about/blogs/text-speech-evolution-synthetic-voices) (article)

## References

- https://roadmap.sh/ai-engineer (Node: Text-to-Speech)

---

[← Audio Processing](/ai-engineer/08-multimodal-ai/audio-processing/) · [AI Engineer Roadmap](/ai-engineer/) · [Speech-to-Text →](/ai-engineer/08-multimodal-ai/speech-to-text/)
