...
description: "Audio processing in multimodal AI enables a wide range of use cases by combining sound with other data types, such as text, images, or video, to create more context-aware systems."
...
- [The State of Audio Processing](https://appwrite.io/blog/post/state-of-audio-processing) (article)
- [Audio Signal Processing for Machine Learning](https://www.youtube.com/watch?v=iCwMQJnKk2c) (video)

## References

- https://roadmap.sh/ai-engineer (Node: Audio Processing)

---

[← Video Understanding](/ai-engineer/08-multimodal-ai/video-understanding/) · [AI Engineer Roadmap](/ai-engineer/) · [Text-to-Speech →](/ai-engineer/08-multimodal-ai/text-to-speech/)
