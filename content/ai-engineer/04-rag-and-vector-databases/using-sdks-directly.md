...
description: "While tools like Langchain and LlamaIndex make it easy to implement RAG, you don't have to necessarily learn and use them."
...
- [Langchain Text Splitter Package](https://www.npmjs.com/package/@langchain/textsplitters) (official)
- [OpenAI Embedding API](https://platform.openai.com/docs/guides/embeddings) (official)
- [Supabase AI & Vector Documentation](https://supabase.com/docs/guides/ai) (official)
...
[← Generation](/ai-engineer/04-rag-and-vector-databases/generation/) · [AI Engineer Roadmap](/ai-engineer/) · [Langchain →](/ai-engineer/04-rag-and-vector-databases/langchain/)
