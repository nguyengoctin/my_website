...
description: "RAG (Retrieval-Augmented Generation) and fine-tuning are two approaches to enhancing language models, but they differ in methodology and use cases."
...
- [RAG vs Fine Tuning: How to Choose the Right Method](https://www.montecarlodata.com/blog-rag-vs-fine-tuning/) (article)
- [RAG vs Finetuning — Which Is the Best Tool to Boost Your LLM Application?](https://towardsdatascience.com/rag-vs-finetuning-which-is-the-best-tool-to-boost-your-llm-application-94654b1eaba7) (article)
- [RAG vs Fine-tuning](https://www.youtube.com/watch?v=00Q0G84kq3M) (video)

## References

- https://roadmap.sh/ai-engineer (Node: RAG vs Fine-tuning)

---

[← RAG Usecases](/ai-engineer/04-rag-and-vector-databases/rag-usecases/) · [AI Engineer Roadmap](/ai-engineer/) · [Chunking →](/ai-engineer/04-rag-and-vector-databases/chunking/)
