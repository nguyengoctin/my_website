---
title: "Generation"
description: "Generation refers to the process where a generative language model, such as GPT, creates a response based on the information retrieved during the retrieval phase."
...
- [What is RAG (Retrieval-Augmented Generation)?](https://aws.amazon.com/what-is/retrieval-augmented-generation/) (article)
- [Retrieval Augmented Generation (RAG) Explained in 8 Minutes!](https://www.youtube.com/watch?v=HREbdmOSQ18) (video)
...
[← Retrieval Process](/ai-engineer/04-rag-and-vector-databases/retrieval-process/) · [AI Engineer Roadmap](/ai-engineer/) · [Using SDKs Directly →](/ai-engineer/04-rag-and-vector-databases/using-sdks-directly/)
