---
title: "FAISS"
description: "FAISS (Facebook AI Similarity Search) is a library developed by Facebook AI for efficient similarity search and clustering of dense vectors, particularly useful for large-scale datasets."
...
- [FAISS](https://ai.meta.com/tools/faiss/) (official)
- [What Is Faiss (Facebook AI Similarity Search)?](https://www.datacamp.com/blog/faiss-facebook-ai-similarity-search) (article)
- [FAISS Vector Library with LangChain and OpenAI](https://www.youtube.com/watch?v=ZCSsIkyCZk4) (video)

## References

- https://roadmap.sh/ai-engineer (Node: FAISS)

---

[← Weaviate](/ai-engineer/04-rag-and-vector-databases/weaviate/) · [AI Engineer Roadmap](/ai-engineer/) · [LanceDB →](/ai-engineer/04-rag-and-vector-databases/lancedb/)
