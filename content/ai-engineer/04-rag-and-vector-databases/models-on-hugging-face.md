...
description: "Embedding models are used to convert raw data like text, code, or images into high-dimensional vectors that capture semantic meaning."
...
- [Hugging Face Embedding Models](https://huggingface.co/models?pipeline_tag=feature-extraction) (official)
- [Hugging Face - Text embeddings & semantic search](https://www.youtube.com/watch?v=OATCgQtNX2o) (video)
...
[← Sentence Transformers](/ai-engineer/04-rag-and-vector-databases/sentence-transformers/) · [AI Engineer Roadmap](/ai-engineer/) · [Vector Databases →](/ai-engineer/04-rag-and-vector-databases/vector-databases/)
