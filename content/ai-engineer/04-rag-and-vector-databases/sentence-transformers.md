...
description: "Sentence Transformers are a type of model designed to generate high-quality embeddings for sentences, allowing them to capture the semantic meaning of text."
...
- [What is BERT?](https://h2o.ai/wiki/bert/) (article)
- [SentenceTransformers Documentation](https://sbert.net/) (article)
- [Using Sentence Transformers at Hugging Face](https://huggingface.co/docs/hub/sentence-transformers) (article)
...
[← Jina](/ai-engineer/04-rag-and-vector-databases/jina/) · [AI Engineer Roadmap](/ai-engineer/) · [Models on Hugging Face →](/ai-engineer/04-rag-and-vector-databases/models-on-hugging-face/)
