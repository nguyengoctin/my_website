...
description: "Vector databases are specialized systems designed to store, index, and retrieve high-dimensional vectors, often used as embeddings that represent data like text, images, or audio."
summary: "Vector databases là các hệ thống chuyên dụng được thiết kế để lưu trữ, lập chỉ mục và truy xuất các vector đa chiều, thường được sử dụng làm các embedding đại diện cho dữ liệu như văn bản, hình ảnh hoặc âm thanh."
slug: "vector-dbs"
date: 2026-08-01
weight: 9
next: "/ai-engineer/02-llm-fundamentals/rags/"
...
- [What are Vector Databases?](https://www.mongodb.com/resources/basics/databases/vector-databases) (article)
...
[← Training](/ai-engineer/02-llm-fundamentals/training/) · [AI Engineer Roadmap](/ai-engineer/) · [RAGs →](/ai-engineer/02-llm-fundamentals/rags/)
