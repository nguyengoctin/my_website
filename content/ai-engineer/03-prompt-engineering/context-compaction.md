...
description: "Context compaction is a technique used to reduce the length of the context provided to a large language model (LLM) without sacrificing relevant information."
...
- [Context Compaction](https://gist.github.com/badlogic/cd2ef65b0697c4dbe2d13fbecb0a0a5f) (article)
